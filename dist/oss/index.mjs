...
// src/oss/src/llms/azure_structured.ts
import { AzureOpenAI as AzureOpenAI2 } from "openai";
var AzureOpenAIStructuredLLM = class {
  constructor(config) {
    var _a2;
    if (!config.apiKey || !((_a2 = config.modelProperties) == null ? void 0 : _a2.endpoint)) {
      throw new Error("Azure OpenAI requires both API key and endpoint");
...
import { AzureOpenAI as AzureOpenAI3 } from "openai";
...
var MemoryGraph = class {
  constructor(config) {
    ...
    let llmConfig = (_g = this.config.llm) == null ? void 0 : _g.config;
    if ((_h = this.config.llm) == null ? void 0 : _h.provider) {
      this.llmProvider = this.config.llm.provider;
    }
    if ((_j = (_i = this.config.graphStore) == null ? void 0 : _i.llm) == null ? void 0 : _j.provider) {
      this.llmProvider = this.config.graphStore.llm.provider;
    }
    if ((_l = (_k = this.config.graphStore) == null ? void 0 : _k.llm) == null ? void 0 : _l.config) {
